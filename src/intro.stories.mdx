...
The components and styles in this library are largely based on the [ONS Design System](https://service-manual.ons.gov.uk/design-system/), but with a number of additions and modifications to make them suitable for a range data visualisation and data journalism projects.
