...
The docs in this site include interactive examples of how to use our components and build page layouts from them, and how to tweak their look and feel with CSS and other tricks.
...
<img src={moreStoriesImg} width="100%" style={{ margin: "2rem 0", maxWidth: 800 }} />

## Other docs pages

Other docs pages offer guidance on how to tweak styles, get help or even how to write your own components.
